            ...
            >
                ...
                <div className="relative flex-shrink-0 w-[80vw] h-full overflow-hidden">
                    <div className="w-[77vw] absolute top-10 left-5 flex justify-between items-start text-[#f4efe7]">
                        <h1 className="text-3xl font-bold italic uppercase">Kitchen<br />Renovations</h1>
                        <p className="border-[1px] rounded-3xl px-2 py-1 text-center text-[0.7rem] uppercase">Expertise: High</p>
                    </div>
                    <img
                        src={acImg1}
                    ...
                    <div className="w-[77vw] absolute bottom-10 left-5 flex justify-between items-start ">
                        <p className="text-[0.68rem] font-bold text-[#f4efe7] uppercase italic">Complete culinary transformations featuring custom cabinetry,<br />modern benchtop replacements, and premium hardware installs.</p>
                ...
                <div className="relative flex-shrink-0 w-[80vw] h-full overflow-hidden">
                    <div className="w-[77vw] absolute top-10 left-5 flex justify-between items-start text-[#f4efe7]">
                        <h1 className="text-3xl font-bold italic uppercase">Flat Pack<br />Assembly</h1>
                        <p className="border-[1px] rounded-3xl px-2 py-1 text-center text-[0.7rem] uppercase">Expertise: Precision</p>
                    </div>
                    <img
                        src={acImg2}
                    ...
                    />
                    <div className="w-[77vw] absolute bottom-10 left-5 flex justify-between items-start ">
                        <p className="text-[0.68rem] font-bold text-[#f4efe7] uppercase italic">Swift and secure assembly of beds, wardrobes, and living room<br />furniture from all major retailers including IKEA and Mocka.</p>
                        <div className="flex justify-center items-center">
                ...
                <div className="relative flex-shrink-0 w-[80vw] h-full overflow-hidden">
                    <div className="w-[77vw] absolute top-10 left-5 flex justify-between items-start text-[#f4efe7]">
                        <h1 className="text-3xl font-bold italic uppercase">Trade<br />Maintenance</h1>
                        <p className="border-[1px] rounded-3xl px-2 py-1 text-center text-[0.7rem] uppercase">Expertise: Licensed</p>
                    </div>
                    <img
                        src={acImg3}
                    ...
                    />
                    <div className="w-[77vw] absolute bottom-10 left-5 flex justify-between items-start ">
                        <p className="text-[0.68rem] font-bold text-[#f4efe7] uppercase italic">Professional electrical repairs, lighting upgrades, and general<br />property maintenance delivered with honest craftsmanship.</p>
                        <div className="flex justify-center items-center">
